...
pub mod pallet {
    ...
    pub struct GenesisConfig<T: Config> {
        /// Genesis content replication factor
        pub replication_factor: ReplicationFactor,
        /// Genesis ipfs replicas
        pub ipfs_replicas: u32,
        /// Genesis pinning nodes per validator
        pub pinning_nodes: u32,
    ...
    impl<T: Config> BuildGenesisConfig for GenesisConfig<T> {
        fn build(&self) {
            ContentReplicationFactor::<T>::put(self.replication_factor);
            NumOfIpfsReplicas::<T>::put(self.ipfs_replicas);
            NumOfPinningNodes::<T>::put(self.pinning_nodes);
        }
    }
    ...
    pub enum Event<T: Config> {
        ...
        ChangedIpfsReplicasNum { ipfs_replicas: u32 },
        ...
        WaitingIpfsNodesCleared { validator: T::ValidatorId },
    }
    ...
    impl<T: Config> Pallet<T> {
        ...
        pub fn set_ipfs_replicas(origin: OriginFor<T>, ipfs_replicas: u32) -> DispatchResult {
            ...
            ensure_root(origin)?;
                ...
                ipfs_replicas
                    .checked_mul(NumOfPinningNodes::<T>::get())
                    .is_some(),
        ...
        pub fn set_pinning_nodes_per_validator(
            ...
            ensure_root(origin)?;
                ...
                pinning_nodes
                    .checked_mul(NumOfIpfsReplicas::<T>::get())
                    .is_some(),
                Error::<T>::IpfsNodesOverflow
            );
        ...
        pub fn register_ipfs_node(
            ...
            let pinning_node = if waiting_ipfs_keys.len() == ipfs_replicas {
                ...
                ring.try_insert(idx, pinning_id)
        ...
        pub fn rm_waiting_ipfs_node(
            ...
            Self::deposit_event(Event::<T>::WaitingIpfsNodeRemoval {
                validator,
                ipfs_node,
            });
